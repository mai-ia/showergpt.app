/*
  # Real-time Features Migration - Fixed Version
  ...
  2. Security
    ...
    - Add policies for secure access with existence checks
...
-- Add unique constraint for user_id to support ON CONFLICT in update_user_presence
DO $$
BEGIN
  IF NOT EXISTS (
